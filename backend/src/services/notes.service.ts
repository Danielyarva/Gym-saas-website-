...
async function assertAuthor(noteId: string, coachId: string) {
...
async function update(noteId: string, coachId: string, body: string, req: Request) {
  const existing = await assertAuthor(noteId, coachId);
...
async function remove(noteId: string, coachId: string, req: Request) {
  const existing = await assertAuthor(noteId, coachId);
